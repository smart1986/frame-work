...
public class RequestTask implements Runnable {
	...
	public boolean equals(final Object o) {
		...
		return request != null ? request.getCmdIndex() == that.request.getCmdIndex()
				: that.request == null;
	...
	public void returnResponse(short code) {
		final RemotingCommand response = RemotingCommand.createResponseCommand(0, code);
		response.setCmdIndex(request.getCmdIndex());
